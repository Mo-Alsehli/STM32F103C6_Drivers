...
// I2C
#define I2C1			                ((I2C_TYPE_DEF*) I2C1_BASE)
#define I2C2			                ((I2C_TYPE_DEF*) I2C2_BASE)
...
#define RCC_I2C2_CLK_EN()				(RCC->APB1ENR |= 1 << 21)
// Clock Reset
